...
// TestScanlineRotatePlotSpriteRecoversOnOutOfBounds locks in the parity fix that
...
func TestScanlineRotatePlotSpriteRecoversOnOutOfBounds(t *testing.T) {
	pix2d.Reset()
	...
	p.ScanlineRotatePlotSprite(0, 2, []int{0}, 1, 0, 1000, 0, 0, 0, []int{1})
