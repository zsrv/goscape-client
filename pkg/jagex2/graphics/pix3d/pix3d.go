...
// SetBrightness is the faithful client entry point (Java: Pix3D.setBrightness at
// cc3781de). It jitters the brightness by a random term
// (rand.Float64()*0.03-0.015, mirroring the Java Math.random() jitter) so each
// run varies slightly. The shared, jitter-free body lives in initColourTable.
...
// InitColourTableDeterministic. var28 is the already-resolved gamma exponent
// (jittered by the faithful caller, exact for the deterministic one). The
// 225-clean initColourTable has NO transparent-collapse guard on the texture
// palette (that guard is a 274-only addition, deliberately absent here to stay
// faithful to the cc3781de pin).
func initColourTable(var28 float64) {
	var3 := 0
	for i := range 512 {
...
func GouraudRaster(arg0 []int, arg1, arg4, arg5, arg6, arg7 int) {
	...
	if LowDetail {
		...
		if HClip {
			...
			arg3 = (arg5 - arg4) >> 2
			if arg3 > 0 {
				// Java: Pix3D.java:860 (pin cc3781de) — 32-bit product wraps before
...
func TextureTriangle(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18 int) {
	...
	// Java: Pix3D.java:1430-1438 (pin cc3781de) — the u/v/w gradient
...
func TextureRaster(arg0 []int, arg1 []int, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14 int) {
	...
	if HClip {
		...
		if arg6-arg5 > 7 {
			var16 = (arg6 - arg5) >> 3
			// Java: Pix3D.java:2042 (pin cc3781de) — 32-bit product wraps before
	...
	if LowMem {
		...
		// Java: Pix3D.java:2065-2067 (pin cc3781de) — perspective numerators are
		...
		// Java: Pix3D.java:2078-2080 (pin cc3781de) — int sums wrap mod 2^32
		...
		if Opaque {
			for ; var16 > 0; var16-- {
				...
				arg2 = var17
				arg3 = var18
				// Java: Pix3D.java:2123-2125 (pin cc3781de) — int += wraps
			...
			for ; var16 > 0; var16-- {
				...
				arg2 = var17
				arg3 = var18
				// Java: Pix3D.java:2206-2208 (pin cc3781de) — int += wraps
				// mod 2^32 before the >>12 divisor (backport of rev-274 audit P6).
				arg9 = int(int32(arg9 + arg12))
				arg10 = int(int32(arg10 + arg13))
				arg11 = int(int32(arg11 + arg14))
	...
	var18 = 0
	var20 = arg5 - CenterW3D
	// Java: Pix3D.java:2241-2243 (pin cc3781de) — perspective numerators are
	// 32-bit int products that wrap mod 2^32 (audit pix3d-C-01). Masked by the
	// arg2 clamp on the F2 overflow golden, but wrapped for Java parity with
	// rev-254/274; the following P6 sums depend on the wrapped value.
	var32 = int(int32(arg9 + (arg12>>3)*var20))
	...
	// Java: Pix3D.java:2254-2256 (pin cc3781de) — int sums wrap mod 2^32
	...
	if Opaque {
		for ; var16 > 0; var16-- {
			...
			arg2 = var17
			arg3 = var18
			// Java: Pix3D.java:2305-2307 (pin cc3781de) — int += wraps
	...
	for ; var16 > 0; var16-- {
		...
		arg2 = var17
		arg3 = var18
		// Java: Pix3D.java:2389-2391 (pin cc3781de) — int += wraps
		// mod 2^32 before the >>14 divisor (backport of rev-274 audit P6).
		arg9 = int(int32(arg9 + arg12))
		arg10 = int(int32(arg10 + arg13))
		arg11 = int(int32(arg11 + arg14))
