...
// palettes. Java: Pix3D.initColourTable (Pix3D.java:251 @2e629784; the Go name
// SetBrightness is pre-254 legacy). The reference client jitters the brightness
...
// (jittered by the faithful caller, exact for the deterministic one). Java 254's
...
// ported here to stay faithful to the 2e629784 pin).
...
func TextureRaster(arg0 []int, arg1 []int, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14 int) {
	...
	if LowMem {
		...
		// Java: Pix3D.java:2252-2254 (pin 2e629784) — int sums wrap mod 2^32
		...
		if Opaque {
			for ; var16 > 0; var16-- {
				...
				arg2 = var17
				arg3 = var18
				// Java: Pix3D.java:2295-2297 (pin 2e629784) — int += wraps
			...
			for ; var16 > 0; var16-- {
				...
				arg2 = var17
				arg3 = var18
				// Java: Pix3D.java:2379-2381 (pin 2e629784) — int += wraps
				// mod 2^32 before the >>12 divisor (backport of rev-274 audit P6).
				arg9 = int(int32(arg9 + arg12))
				arg10 = int(int32(arg10 + arg13))
				arg11 = int(int32(arg11 + arg14))
	...
	// Java: Pix3D.java:2078-2080 (pin 2e629784) — int sums wrap mod 2^32
	...
	if Opaque {
		for ; var16 > 0; var16-- {
			...
			arg2 = var17
			arg3 = var18
			// Java: Pix3D.java:2121-2123 (pin 2e629784) — int += wraps
	...
	for ; var16 > 0; var16-- {
		...
		arg2 = var17
		arg3 = var18
		// Java: Pix3D.java:2204-2206 (pin 2e629784) — int += wraps
		// mod 2^32 before the >>14 divisor (backport of rev-274 audit P6).
		arg9 = int(int32(arg9 + arg12))
		arg10 = int(int32(arg10 + arg13))
		arg11 = int(int32(arg11 + arg14))
