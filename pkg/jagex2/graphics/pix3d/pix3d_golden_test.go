...
// LostCityRS/Client-Java render code (commit 2e629784). Two artifacts under
...
//
//	Java: Pix2D.setPixels(W, px, H); Pix3D.init();
//	    Pix3D.lowDetail = c.lowDetail; Pix3D.hclip = c.hclip; Pix3D.trans = c.trans
//
// Go equivalents:
//   - pix2d.SetPixels(width, data, height)  == Java Pix2D.setPixels(W, px, H)
//   - pix3d.Init()                          == Java Pix3D.init() (setRenderClipping)
