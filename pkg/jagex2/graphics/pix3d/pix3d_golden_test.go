...
// LostCityRS/Client-Java render code (commit 01f16088). Two artifacts under
...
//
// Go equivalents:
//   - pix2d.SetPixels(width, data, height)  == Java Pix2D.bind (width, data, height)
...
// Mappings verified against the Java Pix3D signatures at 01f16088 and the Go
