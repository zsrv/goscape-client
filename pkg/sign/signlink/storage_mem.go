...
//
// The mutex is held defensively: the cacheStore interface contract does not
// require synchronization (single-goroutine caller), but the lock keeps
// memStore safe under concurrent access such as parallel test goroutines.
