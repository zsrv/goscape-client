// Command icondump renders every item-inventory icon in a rev-244 game cache
...
// goldens (commit 01f16088; see cmd/icondump/icondump_test.go and
// tools/iconref/java/).
//
// Usage:
//
...
// legitimate skip. Java 244 arg order: getIcon(outlineRgb, count, id).
